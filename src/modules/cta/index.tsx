      ...
      <div className="container max-w-7xl mx-auto">
        <div className="animate-fade-in">
          ...
          <div className="relative mb-8">
            ...
            <div className="flex flex-col items-center p-12 bg-gradient-card rounded-3xl border border-primary/20 backdrop-blur-sm shadow-elevated">
              ...
              <h2 className="flex flex-col items-center font-bold text-4xl md:text-6xl mb-6 bg-gradient-primary bg-clip-text text-transparent leading-tight">
